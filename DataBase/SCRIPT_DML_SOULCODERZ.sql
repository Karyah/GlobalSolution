...
insert into Usuario (login, nome, email, senha) values('luffy','Carlos Antônio','dluffycarlos@bol.com','onepice987');
...
insert into Usuario (login, nome, email, senha) values('mariahhh','Maria José','marijose@gmail.com','judelsoi123');
...
insert into Ponto (endereco, idUsuario) values('Rua dos Imigrantes, número 25',6);

insert into Ponto (endereco, idUsuario) values('Rua São João, 87',7);

insert into Ponto (endereco, idUsuario) values('Rua Quinze de Novembro, Centro. Em frente ao número 140.',8);
...
insert into Ponto (endereco, idUsuario) values('Rua José Paulino, n° 307.',1);

insert into Bicicleta (serial, tamanho, disponibilidade) values ('AC7008896','Kids', 'Disponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('BZO90123','Adulto', 'Indisponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('ZDA983214','Adulto', 'Indisponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('KHL0098392','Adulto', 'Disponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('POL8923470','Kids', 'Disponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('JJD2384510','Adulto', 'Disponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('AAV001213','Kids', 'Indisponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('CD998012','Adulto', 'Disponível');

insert into Bicicleta (serial, tamanho, disponibilidade) values ('BER7324657','Kids', 'Disponível');
